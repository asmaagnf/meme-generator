 ...
 */
function clearAll() {
   const clearMeme = document.querySelector('.meme-content');
   const clearQuote = document.querySelector('.quote-content');
   const clearJokes = document.querySelector('.joke-content');
   const clearridddles = document.querySelector('.riddle-content');
   clearMeme.innerHTML = "";
   clearQuote.innerHTML = "";
   clearJokes.innerHTML = "";
   clearridddles.innerHTML = "";
    }
...
function showMeme() {
  ...
  const elem = document.querySelector('.meme-content');
  const createElement = document.createElement('img');
  createElement.setAttribute("src", randomMemeUrl);
  clearAll();
...
function showJoke() {
  ...
  const jk = document.querySelector('.joke-content');
  const createP = document.createElement('p');
   createP.textContent = randomJokeText;
   clearAll();
  jk.appendChild(createP);
}
...
function showQuote() {
  ...
  const createP2 = document.createElement('p');
   createP2.textContent = randomQuote.quote;
   clearAll();
  quoteContainer.appendChild(createP2);
}
...
function showRiddle() {
  ...
  createP3.textContent = randomRiddle.question;
  createP4.textContent = "--"  + randomRiddle.answer;
  createP4.setAttribute("id", "riddle-answer");
  clearAll();
  createP4.hidden = true;
  riddleContainer.appendChild(createP3);
  riddleContainer.appendChild(createP4);
